...
export type DevdeckDependencyCondition = "started" | "ready" | "healthy" | "completed_successfully";
export type DevdeckDependencyConfig = {
    condition?: DevdeckDependencyCondition;
};
export type DevdeckHealthConfig = DevdeckTcpHealthConfig | DevdeckHttpHealthConfig | DevdeckCommandHealthConfig;
...
export type DevdeckReadinessConfig = DevdeckLogReadinessConfig | DevdeckTcpReadinessConfig | DevdeckHttpReadinessConfig;
